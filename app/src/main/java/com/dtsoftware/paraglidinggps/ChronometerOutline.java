...
public class ChronometerOutline extends Chronometer {
    ...
    public ChronometerOutline(Context context) {
        this(context, null);
    }

    public ChronometerOutline(Context context, AttributeSet attrs) {
        super(context, attrs);
        setAttributes(attrs);
    }
